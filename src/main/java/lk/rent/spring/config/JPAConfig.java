...
@Configuration
@EnableJpaRepositories(basePackages = "lk.rent.spring.repo")
...
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource source, JpaVendorAdapter adapter) {
        ...
        bean.setPackagesToScan(environment.getRequiredProperty("my.app.entity"));
        return bean;
    }
    ...
    public DataSource dataSource() throws NamingException {
        ...
        dataSource.setDriverClassName(environment.getRequiredProperty("my.app.driver"));
        return dataSource;
    }
